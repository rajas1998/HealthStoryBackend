...
for index, i in enumerate(x):
    ...
    high_data.append([curr_date, high_bp_pdf[index]])
    low_data.append([curr_date, low_bp_pdf[index]])
    resp_data.append([curr_date, resp_pdf[index]])
...
with open("../data/users/1/urine.pkl", "wb") as f:
    urine = [
        [date.fromisoformat("2019-12-01"), 129],
        [date.fromisoformat("2020-03-19"), 147],
    ]
    pkl.dump(urine, f)

with open("../data/users/1/ecg.pkl", "wb") as f:
    ecg = [[date.fromisoformat("2019-08-28"), 73]]
    pkl.dump(ecg, f)

with open("../data/users/1/echo.pkl", "wb") as f:
    echo = [[date.fromisoformat("2019-08-28"), 84]]
    pkl.dump(echo, f)

with open("../data/users/1/blood.pkl", "wb") as f:
    blood = [
        [date.fromisoformat("2020-03-01"), 53.7],
        [date.fromisoformat("2020-05-26"), 48.2],
    ]
    pkl.dump(blood, f)

with open("../data/users/1/meta.pkl", "wb") as f:
    meta = [
        [date.fromisoformat("2020-03-01"), 146.7],
        [date.fromisoformat("2020-05-26"), 139.4],
    ]
    pkl.dump(meta, f)
...
with open("../data/users/1/tests.pkl", "wb") as f:
    tests = {
        "Urine": [
            date.fromisoformat("2020-03-19"),
        ],
        "ECG": [date.fromisoformat("2019-08-28")],
        "Echocardiogram": [date.fromisoformat("2019-08-28")],
        "Blood": [
...
with open("../data/users/1/recommended_tests.pkl", "wb") as f:
    tests = {
        "Urine": [
            date.fromisoformat("2020-02-18"),
        ],
        "ECG": [date.fromisoformat("2019-08-02"), date.fromisoformat("2020-05-21")],
        "Echocardiogram": [
...
with open("../data/users/1/soaps.pkl", "wb") as f:
    soap_list = {
        ...
        2: {
            "date": date.fromisoformat("2020-02-18"),
        ...
        3: {
            "date": date.fromisoformat("2020-05-21"),
            "subjective": """The patient reports feeling generally well since their last visit but has noticed some mild dizziness and fatigue lately. They also report experiencing some mild headaches and have been having some trouble sleeping. They state that they have been taking their medication regularly and have been following a healthy diet.""",
            "objective": """Blood pressure today is 130/80 mmHg, which
             is an improvement from last visit. A blood count and metabolic panel were ordered since the patient has been on the new medication for the past 3 months. The blood count came back within normal limits. However, the metabolic panel showed elevated liver enzymes and potassium levels, which may be related to the patient's new medication. """,
            "assessment": """The patient's blood pressure is improving, but they have been experiencing some mild side effects with their new medication, including elevated liver enzymes and potassium levels. The patient's symptoms of dizziness, fatigue, and headaches may be related to their medication or could be due to other factors, such as lack of sleep. The ECG showed no significant changes.""",
            "plan": """The patient will also be advised to follow up with their primary care physician for further liver function tests. . The patient will be advised to monitor their blood pressure at home and report any significant changes. An electrocardiogram (ECG) and echocardiogram tests have been ordered to get a comprehensive overview of the recovery. They will also be advised to improve their sleep hygiene and to manage their stress levels to alleviate their symptoms of dizziness, fatigue, and headaches. A follow-up appointment in 3 months will be scheduled to monitor the patient's blood pressure and medication tolerance.""",
        },
        4: {
            "date": date.fromisoformat("2020-09-01"),
            "subjective": """"I feel so much better now that I've made some changes. I'm grateful for the support." The patient expresses gratitude for the progress they have made in managing their hypertension.  The patient also reported that they have been taking their medications regularly and have been following the dietary and exercise guidelines as recommended.""",
            ...
            "assessment": """The patient's blood pressure has been well-controlled and there has been an improvement in kidney function and normal liver function, as evidenced by the latest blood test results. The patient has been compliant with medication and lifestyle modifications.""",
            "plan": """The patient's medication has been reduced from 10mg of Lisinopril to 5mg, as the blood pressure readings have been stable. The patient will continue taking the reduced dosage and will return for follow-up in 6 months for blood pressure monitoring and kidney function tests. The patient will also continue to adhere to the recommended dietary and exercise guidelines.""",
        },
    }
